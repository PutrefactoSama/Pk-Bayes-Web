 ...
 * Totalmente automatizado con generación de clave temporal.
 */
      ...
      try {
        ...
        if (event.type === "checkout.session.completed") {
          ...
          if (email && resendKey) {
            ...
            // Correo 2 Automático: Credenciales con clave temporal
            await fetch("https://api.resend.com/emails", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
                  ...
                  <div style="font-family:sans-serif;max-width:600px;margin:0 auto;padding:24px;border:1px solid #e2e8f0;border-radius:12px;color:#1e293b">
                    ...
                    <div style="background:#f0fdf4;border:1px solid #bbf7d0;padding:16px;border-radius:8px;margin-top:24px">
                      ...
                      <p style="margin:0;font-size:13px;color:#166534;line-height:1.6">
                        • Correo 1: Confirmación de pago enviado al cliente.<br>
                        • Correo 2: Credenciales con clave temporal <code>${tempPassword}</code> enviado al cliente.<br>
                        • Alerta de venta recibida en tu bandeja.
                      </p>
                    </div>
          ...
          return new Response(JSON.stringify({ ok: true, temp_password: tempPassword }), { headers: { "Content-Type": "application/json" } });
        }
